 ...
 * {@link CombinedFragment.OnCombinedFragmentInteractionListener} interface
...
public class CombinedFragment extends Fragment {
    ...
    private OnCombinedFragmentInteractionListener mListener;
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onCombinedFragmentInteraction(uri);
        }
    }
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            mListener = (OnCombinedFragmentInteractionListener) activity;
     ...
     */
    public interface OnCombinedFragmentInteractionListener {
