 ...
 * {@link HorizontalScrollFragment.OnHorizontalFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link HorizontalScrollFragment#newInstance} factory method to
...
public class HorizontalScrollFragment extends Fragment {
    ...
    public static HorizontalScrollFragment newInstance(String param1, String param2) {
        HorizontalScrollFragment fragment = new HorizontalScrollFragment();
    ...
    public HorizontalScrollFragment() {
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.onHorizontalFragmentInteraction(uri);
        }
    }
